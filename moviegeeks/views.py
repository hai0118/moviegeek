...
def search_for_person(request):
    ...
    rows = Movie.objects.all()[slice: slice + 10]
    ...
    return render(request, 'moviegeek/person.html', context_dict)


def search_for_group(request):
    ...
    return render(request, "moviegeek/group.html", context_dict)
